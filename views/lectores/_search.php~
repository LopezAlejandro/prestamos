...
<div class="form-lectores-search">
    ...
    <?php /* echo $form->field($model, 'estado')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\models\EstadoLector::find()->orderBy('estado_id')->asArray()->all(), 'estado_id', 'estado_id'),
